...
import json
from satisfactory.base import ConveyanceType, InfiniteSupplyNode
from satisfactory.buildings import Assembler
from satisfactory.conveyances import ConveyorBeltMk2
from satisfactory.items import IronPlate as iIronPlate, Screw as iScrew
from satisfactory.factories import Factory
from satisfactory.recipes import ReinforcedIronPlate as rReinforcedIronPlate
from satisfactory.storages import StorageContainer


factory = Factory(name='Infinite Reinforced Iron Plates', tier=1, upgrade=2)
...
assRIP = Assembler(name='Reinforced Iron Plate Assembler', recipe=rReinforcedIronPlate)
...
factory.add([infiniteIronPlates, infiniteScrews, assRIP, storRIP])
