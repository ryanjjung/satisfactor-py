...
class Factory(Base):
    ...
    def to_dict(self) -> dict:
        ...
        base = super().to_dict()
        base.update({'components': [component.to_dict() for component in self.components]})
        return base
    ...
    def resource_nodes(self) -> list[ResourceNode]:
        ...
        return [component for component in self._components if isinstance(component, ResourceNode)]

    def add(self, components: list[Component] | list[list[Component]]):
        """
    ...
    def get_buildings_by_type(self, building_type: BuildingType) -> list[Building]:
        ...
        return [
            ...
            if isinstance(component, Building) and component.building_type == building_type
        ]
    ...
    def get_components_by_name(self, name: str, fuzzy: bool = False) -> list[Component]:
        """
    ...
    def get_components_by_tag(self, key: str, value: str | None = None, fuzzy: bool = True) -> list[Component]:
        """
    ...
    def get_errors(self) -> dict[str, list[ComponentError]]:
        ...
        return {component.id: component.errors for component in self.components if len(component.errors) > 0}
    ...
    def simulate(self):
        ...
        if len(excluded) > 0:
            self.add_error(
                ComponentError(ComponentErrorLevel.WARNING, f'Some components were not traversed: {excluded}')
            )

    def simulate_multi(self, components: list[Component]):
        """
    ...
    def traverse(self, cursor: Component, func: Callable):
        """
    ...
    def traverse_all(self, func: Callable):
        """
    ...
    def traverse_multi(self, components: list[Component], func: Callable):
        """
