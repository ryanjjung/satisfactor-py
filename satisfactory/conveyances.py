from satisfactory.base import Availability, Conveyance, ConveyanceType, Dimension, Input, Output
...
class ConveyorBeltMk1(Conveyance):
    ...
    def __init__(self, name: str = 'Conveyor Belt Mk.1', **kwargs):
        super().__init__(
            name=name,
...
class ConveyorBeltMk2(Conveyance):
    ...
    def __init__(self, name='Conveyor Belt Mk.2', **kwargs):
        super().__init__(
            name=name,
...
class ConveyorLiftMk1(Conveyance):
    def __init__(self, name='Conveyor Lift Mk.1', **kwargs):
        super().__init__(
            name=name,
...
class ConveyorLiftMk2(Conveyance):
    def __init__(self, name='Conveyor Lift Mk.2', **kwargs):
        super().__init__(
            name=name,
            availability=Availability(2, 5),
            ...
            conveyance_type=ConveyanceType.BELT,
            rate=120,
            dimensions=Dimension(width=2, length=2, height=7),
            inputs=[Input(attached_to=self, conveyance_type=ConveyanceType.BELT)],
            outputs=[Output(attached_to=self, conveyance_type=ConveyanceType.BELT)],
            **kwargs,
        )
...
class PipelineMk1(Conveyance):
    ...
    def __init__(self, name='Pipeline Mk. 1', **kwargs):
        super().__init__(
            name=name,
            availability=Availability(0, 4),
            ...
            rate=300,
            dimensions=Dimension(width=2, length=1, height=2),
            inputs=[Input(attached_to=self, conveyance_type=ConveyanceType.PIPE)],
            outputs=[Output(attached_to=self, conveyance_type=ConveyanceType.PIPE)],
            **kwargs,
        )
...
class PipelinePump(Conveyance):
    ...
    def __init__(self, name='Pipeline Pump Mk. 1', **kwargs):
        super().__init__(
            name=name,
            ...
            conveyance_type=ConveyanceType.PIPE,
            dimensions=Dimension(width=2, length=4, height=2),
            inputs=[Input(attached_to=self, conveyance_type=ConveyanceType.PIPE)],
            outputs=[Output(attached_to=self, conveyance_type=ConveyanceType.PIPE)],
            **kwargs,
        )
