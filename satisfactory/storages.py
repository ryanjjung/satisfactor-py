from satisfactory.base import Availability, ConveyanceType, Dimension, Input, Output, Storage
...
class FluidBuffer(Storage):
    ...
    def __init__(self, name: str = 'Fluid Buffer', **kwargs):
        super().__init__(
            name=name,
            ...
            stacks=400,
            dimensions=Dimension(width=6, length=6, height=8),
...
class StorageContainer(Storage):
    ...
    def __init__(self, name: str = 'Storage Container', **kwargs):
        super().__init__(
            name=name,
            ...
            stacks=24,
            dimensions=Dimension(width=5, length=10, height=4),
